...
-- 2. 插入菜品
-- 招牌热菜
INSERT INTO `pms_dish` (`id`, `name`, `category_id`, `price`, `status`, `daily_stock`, `alert_threshold`, `ingredients`, `allergens`, `create_time`, `update_time`) VALUES
(1, '水煮鱼', 1, 88.00, 1, 50, 10, '["草鱼", "黄豆芽", "辣椒", "花椒"]', '["鱼", "大豆"]', NOW(), NOW()),
(2, '宫保鸡丁', 1, 38.00, 1, 100, 20, '["鸡胸肉", "花生米", "大葱", "干辣椒"]', '["花生"]', NOW(), NOW()),
...
INSERT INTO `oms_order_detail` (`id`, `order_id`, `dish_id`, `dish_name`, `quantity`, `price`, `is_added`, `create_time`) VALUES
(3, 2, 2, '宫保鸡丁', 1, 38.00, 0, DATEADD(MINUTE, -30, NOW())),
(4, 2, 6, '可口可乐', 2, 5.00, 0, DATEADD(MINUTE, -30, NOW()));
